...
- Write them under `.pi-web-uploads/artifacts/` in the current working directory.
...
The `/api/artifacts/<filename>` route only serves files from `.pi-web-uploads/artifacts/`.
